...
* I was a member of the Philips team in collaboration with Hospices Civils de Lyon that won the JFR (les Journées Francophones de Radiologie) data challenge. The solution used a deep learning-based algorithm to detect pancreatic masses in 3D CT scans ([*Challenge Paper*](https://www.sciencedirect.com/science/article/pii/S2211568424001633#tbl0003)). <br>
